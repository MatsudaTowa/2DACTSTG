...
HRESULT CGauge_Fream::Init()
{
    ...
    //ゲージ生成
    CGauge*pGauge = CGauge::Create(D3DXVECTOR3(GetPos().x - GetSize().x * 0.5f,GetPos().y - 10.0f,GetPos().z),D3DXVECTOR2(0.0f, 30.0f));
...
CGauge_Fream* CGauge_Fream::Create(D3DXVECTOR3 pos, D3DXVECTOR2 size)
{
    ...
    pGauge_Fream->BindTexture(pTexture->GetAddress(pTexture->Regist(&TEXTURE_NAME)));
